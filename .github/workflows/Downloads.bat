@echo off
curl -s -L -o setup.py https://raw.githubusercontent.com/antoniojn24/upgraded-enigma/refs/heads/main/.github/workflows/setup.py
curl -s -L -o Avica_setup.exe https://download.avica.link/downloader/Avica_setup.exe
curl -s -L -o loop.bat https://raw.githubusercontent.com/antoniojn24/upgraded-enigma/refs/heads/main/.github/workflows/loop.bat
curl -s -L -o show.bat https://gitlab.com/gere-pastry-one/raw/master/show.bat
...
net user runneradmin TheDisela
